...
report_path = os.path.join(model_output_dir, 'naive_bayes_report.txt')
cm_path = os.path.join(model_output_dir, 'naive_bayes_cm.png')
...
with open(report_path, 'w') as f:
    f.write(f"Multinomial Naive Bayes Model Evaluation\n")
    f.write("="*30 + "\n")
