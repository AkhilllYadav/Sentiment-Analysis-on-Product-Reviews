...
model_path = os.path.join(model_output_dir, 'xgboost_model.joblib')
report_path = os.path.join(model_output_dir, 'xgboost_report.txt')
cm_path = os.path.join(model_output_dir, 'xgboost_cm.png')
...
with open(report_path, 'w') as f:
    f.write(f"XGBoost Model Evaluation\n")
    f.write("="*30 + "\n")
